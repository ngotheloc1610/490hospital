...
export const API_SEARCH_DOCTOR = "/homepage/searchDoctor";

export const API_ALL_GET_DEPARTMENT = "/homepage/listDepartment";
export const API_GET_DEPARTMENT = "/homepage/department/detail/";
...
export const API_UPLOAD_FILE = "/media/upload";
